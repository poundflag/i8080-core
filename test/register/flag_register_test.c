...
void test_set_the_auxiliary_to_true() { TEST_ASSERT_EQUAL_INT(is_result_auxiliary_carry(0xF, 0xF, PLUS_OPERATION), 1); }

void test_set_the_auxiliary_to_false() { TEST_ASSERT_EQUAL_INT(is_result_auxiliary_carry(1, 1, PLUS_OPERATION), 0); }
...
void test_addition_test() {
    TEST_ASSERT_EQUAL_INT(process_flag_register(0xC9, 0x10, PLUS_OPERATION), 0b10000010);
    TEST_ASSERT_EQUAL_INT(process_flag_register(0xA1, 0xC9, PLUS_OPERATION), 0b00000111);
    TEST_ASSERT_EQUAL_INT(process_flag_register(0xDE, 0xFE, PLUS_OPERATION), 0b10010011);
    TEST_ASSERT_EQUAL_INT(process_flag_register(0xC9, 0x10, PLUS_OPERATION), 0b10000010);
    TEST_ASSERT_EQUAL_INT(process_flag_register(0x20, 0x30, PLUS_OPERATION), 0b00000110);
    TEST_ASSERT_EQUAL_INT(process_flag_register(0x20, 0x30, PLUS_OPERATION), 0b00000110);
    TEST_ASSERT_EQUAL_INT(process_flag_register(0x80, 0x41, PLUS_OPERATION), 0b10000010);
    TEST_ASSERT_EQUAL_INT(process_flag_register(0x01, 0xD2, PLUS_OPERATION), 0b10000010);
}

void test_subtraction_test() {
    TEST_ASSERT_EQUAL_INT(process_flag_register(0x23, 0x45, SUBTRACTION_OPERATION), 0b10000111);
    TEST_ASSERT_EQUAL_INT(process_flag_register(0x00, 0xAA, SUBTRACTION_OPERATION), 0b00000111);
    TEST_ASSERT_EQUAL_INT(process_flag_register(0x21, 0xDE, SUBTRACTION_OPERATION), 0b00000011);
    TEST_ASSERT_EQUAL_INT(process_flag_register(0x1, 0x20, SUBTRACTION_OPERATION), 0b10010111);
    TEST_ASSERT_EQUAL_INT(process_flag_register(0x23, 0xFE, SUBTRACTION_OPERATION), 0b00000011);
    TEST_ASSERT_EQUAL_INT(process_flag_register(0x11, 0x11, SUBTRACTION_OPERATION), 0b01010110);
    TEST_ASSERT_EQUAL_INT(process_flag_register(0xDE, 0xFE, SUBTRACTION_OPERATION), 0b10000011);
}
