...
void test_get_a_register_and_have_the_default_value() {
...
void test_get_a_register_pair_and_have_the_default_value() {
...
void test_get_a_program_counter_and_have_the_default_value() {
...
void test_have_the_default_flag_value() {
