...
typedef enum { REG_A, REG_B, REG_C, REG_D, REG_E, REG_H, REG_L, REG_F, REG_ENUM_SIZE, REG_M } Register;

typedef enum { PAIR_PSW, PAIR_B, PAIR_D, PAIR_H, PAIR_ENUM_SIZE, PAIR_SP } Register_Pair;

typedef enum { CARRY = 0, PARITY = 2, AUXILIARY = 4, ZERO = 6, SIGNED = 7 } Flag_Type;
